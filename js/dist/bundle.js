	...
	(function () {
	  ...
	  if (formsToggle[0]) {
	    formsToggle.forEach(function (el) {
	      ...
	      var formSignInFlip = el.getElementsByClassName('form-sign-in-flip');
	      var formSignUpFlip = el.getElementsByClassName('form-sign-up-flip');
	      var flipper = el.getElementsByClassName('flipper');
...
/***/ function(module, exports) {
	...
	(function () {
	  ...
	  function imgLoad() {
	    var doc = document;
	    var imgTop = [].slice.call(doc.getElementsByClassName('imgload-top'));

	    var imgBtm = [].slice.call(doc.getElementsByClassName('imgload-bottom'));

	    var imgTopLast = void 0;
	    if (imgTop[0]) {
